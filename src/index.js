...
global.DATA = Vue.prototype.DATA = {
  atom: {
    alias: "atom", title: "Atom", type: 4, for_what: "Высоко и среднеуровневые языки", need: true,
    videos: [{},],
    books: [{},],
  },
  brackets: {
    alias: "brackets", title: "Brackets", type: 4, for_what: "Высоко и среднеуровневые языки", need: true,
    videos: [{},],
    books: [{},],
  },
  c: {
