    ...
    <ul class="navbar-nav">
      <li class="nav-btn">
        <a href="#" class="btn btn-sm btn-dark mr-2"
           @click="modalTitle='Login', loginPlaceholder='', showPass=true, showModal=!showModal">Login</a>
      </li>
      <li class="nav-btn">
        <a href="#" class="btn btn-sm btn-outline-secondary"
           @click="modalTitle='Sign up', loginPlaceholder=' or email', showPass=true, showModal=!showModal">Sign
          up</a>
      </li>
    </ul>
    <!--Modal-->
          ...
          <div class="modal-body">
            <form method="post" action="">
              ...
              <div class="d-flex justify-content-end">
                ...
                <button type="submit" class="btn btn-dark" name="authorization">
                  Login
                </button>
              </div>
            </form>
